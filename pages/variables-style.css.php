...
:root {
  ...
  --accueil-secondary-text-color: hsl(300, 25%, 30%);
  ...
  --bio-secondary-text-color: hsl(159, 35%, 23%);
  ...
  --projets-secondary-text-color: hsl(230, 25%, 32%);
  ...
  --articles-secondary-text-color: hsl(11, 25%, 30%);
  ...
  --contact-secondary-text-color: hsl(180, 0%, 28%);
...
@media (prefers-color-scheme: dark) {
  ...
  --accueil-secondary-text-color: hsl(300, 25%, 70%);
  ...
  --bio-secondary-text-color: hsl(160, 21%, 62%);
  ...
  --projets-secondary-text-color: hsl(230, 29%, 72%);
  ...
  --articles-secondary-text-color: hsl(11, 26%, 69%);
  ...
  --contact-secondary-text-color: hsl(0, 0%, 67%);
...
body[data-section="accueil"] {
  ...
  --secondary-text-color: var(--accueil-secondary-text-color);
}

/* Page bio */
body[data-section="bio"] {
  ...
  --secondary-text-color: var(--bio-secondary-text-color);
}

/* Page projets */
body[data-section="projets"] {
  ...
  --secondary-text-color: var(--projets-secondary-text-color);
}
...
body[data-section="articles"] {
  ...
  --secondary-text-color: var(--articles-secondary-text-color);
}
...
body[data-section="contact"] {
  ...
  --secondary-text-color: var(--contact-secondary-text-color);
}
